...
async function seed() {
  ...
  const productsData = [
    ...
    // SSDs
    { name: 'Kingston A400 240GB 2.5 inch SATA3', image: 'https://placehold.co/400x300?text=Kingston+A400', category: getCatId('SSD'), brand: 'Kingston', price: 550000, stockQuantity: 25, specs: '240GB SATA3', description: 'Nâng cấp tốc độ máy tính cũ cực tốt', attributes: { capacity: 240 } },
    { name: 'Samsung 980 500GB M.2 NVMe PCIe Gen3', image: 'https://placehold.co/400x300?text=Samsung+980', category: getCatId('SSD'), brand: 'Samsung', price: 1290000, stockQuantity: 16, specs: '500GB NVMe PCIe Gen3', description: 'SSD tốc độ cao đáng tin cậy của Samsung', attributes: { capacity: 500 } },
    ...
    { name: 'Samsung 990 PRO 1TB M.2 NVMe PCIe Gen4 x4', image: 'https://placehold.co/400x300?text=Samsung+990+PRO', category: getCatId('SSD'), brand: 'Samsung', price: 2890000, stockQuantity: 6, specs: '1TB NVMe PCIe Gen4, Tốc độ đọc 7450MB/s', description: 'Ông vua SSD Gen 4 tốc độ khủng khiếp', attributes: { capacity: 1000 } },
